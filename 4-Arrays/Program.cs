...
namespace Arrays
{
    class Program
    {
        ...
        public static Complex MaxModulus(Complex[] array)
        {
            ...
            return max; // TODO: remove this line
        }
        ...
        /// </summary>
        /// <param name="result">an array of <see cref="Complex"/> numbers</param>
        /// <returns>the shallow copy of <paramref name="result"/></returns>
